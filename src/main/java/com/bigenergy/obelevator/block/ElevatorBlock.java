...
public class ElevatorBlock extends Block {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        player.sendMessage(Text.translatableWithFallback("msg.obelevator.block.elevator.direction_set", "Set elevator direction to %s",
                Text.translatableWithFallback("obelevator.msg." + direction.asString(), direction.asString()).getString()), true);
